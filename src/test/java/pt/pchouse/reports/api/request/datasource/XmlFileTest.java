...
@SpringBootTest
public class XmlFileTest extends Generic<XmlFile> {
    ...
    void testBean() {
        ...
        String xml = "a base64 xml string encoded";

        XmlFile xmlFile = appContext.getBean(XmlFile.class);

        xmlFile.setXml(xml);
        xmlFile.setDatePattern(datePattern);
        xmlFile.setNumberPattern(numberPatter);

        assertThat(xmlFile.getXml()).isEqualTo(xml);
        assertThat(xmlFile.getDatePattern()).isEqualTo(datePattern);
        assertThat(xmlFile.getNumberPattern()).isEqualTo(numberPatter);
